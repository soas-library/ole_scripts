...
# @edited_date: 2017-09-21 Added Simon Barron and Alistair Patient to error alert emails
# @edited_date: 2017-09-27 Added Garin Harbottle to error alert emails
...
sub environment {
    ...
    switch ($env) {
        case 'Test' {
            ...
            $EMAIL_ADDRESS                  ='ft9@soas.ac.uk ap87@soas.ac.uk sb174@soas.ac.uk csbs@soas.ac.uk';
        }
        case 'Live' {
            ...
            $EMAIL_ADDRESS                  ='library.systems@soas.ac.uk md11@soas.ac.uk as126@soas.ac.uk bj1@soas.ac.uk ft9@soas.ac.uk ap87@soas.ac.uk sb174@soas.ac.uk gh137@soas.ac.uk csbs@soas.ac.uk';
        }
    }
}
...
sub check_environment {
    ...
    log_message("Info:\tAll required directroies located");
}
